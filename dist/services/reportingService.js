...
exports.generateReportInExcel = exports.generateReport = void 0;
...
function generateReportInExcel(startDate, endDate) {
    return __awaiter(this, void 0, void 0, function* () {
        const reportData = yield generateReport(startDate, endDate);
...
exports.generateReportInExcel = generateReportInExcel;
